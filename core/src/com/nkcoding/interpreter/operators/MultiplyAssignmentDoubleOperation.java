...
public class MultiplyAssignmentDoubleOperation extends MultiplyDoubleOperation implements Statement {

    private String name;

    public MultiplyAssignmentDoubleOperation(String name){
        this.name = name;
    }
